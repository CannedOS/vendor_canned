...
ALARM_PATH := vendor/canned/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/canned/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/canned/prebuilt/common/media/audio/ringtones
